        ...
        <div className="min-h-screen flex flex-col bg-white text-gray-800">
            ...
            <div
                className={`md:hidden bg-white text-black shadow-md absolute w-full left-0 z-10 px-6 py-4 space-y-4 transition-all duration-300 ease-in-out overflow-hidden
                    ${isOpen ? 'top-20 opacity-100 max-h-96' : 'top-16 opacity-0 max-h-0 pointer-events-none'}
                `}
                >
                <a href="#services" onClick={() => setIsOpen(false)} className="block hover:text-gray-600">
                    Services
                </a>
                <a href="#about" onClick={() => setIsOpen(false)} className="block hover:text-gray-600">
                    About
                </a>
